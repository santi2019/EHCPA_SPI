...
/**
 * Componente MapMouseCoordinates: Permite visualizar las coordenadas del mouse, mientras se desplaza sobre el mapa, calculandose automaticamente. 
 * Su estructura es la siguiente:
 * - coordinatesMap: Contenedor general.
 * - coordinatesItems: Contenedor que se utiliza para estructurar el contenido que permite desde la obtencion de las coordenadas hasta la visualizacion 
 *   de las mismas.
...
const MapMouseCoordinates = ({isMouseOverComponent, setIsMouseOverComponent}) => {
    ...
    /** Estados y variables:
     * - coordinates: Este estado inicializa las coordenadas en 0, y se utiliza "setCoordinates" para actualizar el valor de las coordenadas conforme 
     *   el mouse se mueva sobre el mapa.
    ...
    */
    ...
    /**
     * Funcion HandleGetCoordinates: Sirve para obentener las coordenadas del mouse a medida que se desplaza sobre el mapa.
     * 1. Antes de actualizar las coordenadas, se verifica:
     *    - Si el mouse no esta sobre un componente especifico determinado por "isMouseOverComponent" el cálculo de las coordenadas se detiene.
     *    - Caso contrario, se actualizan las coordenadas (lat, lng) con las posiciones actuales del mouse, redondeando los valores a 3 decimales.
